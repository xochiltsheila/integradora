...
<head>
	...
	<script type="text/javascript" src="../js/validacionamerica.js"></script>
			...
			<div class="container">
				<div class="container">
					<form name="pago" method="post" action="direc.php" onsubmit="return validar();">
						...
						<br>
						<input type="text" name="cosa" id="cosa" size="30" maxlength="16" placeholder="373889957002756" class="col s12 m12 l12">
						<br>
						<br>
						<label>Fecha de Caducidad</label>
						<br>
						<input type="text" name="mes" id="mes" size="03" maxlength="2" placeholder="05" class="col s5 m5 l5"> 
