		...
		<div class="container">
			<div class="row">
				...
				<div class="producto">
					<div class="card horizontal">
						...
						<div class="card-stacked">
							...
							<div class="card-action">
								<h5><a href="#" data-id="<?php echo $datos[$i]['Id']?>">< class="eliminar">Eliminar</a></h5>
							</div>
						</div>
					</div>
				</div>
					...
					echo '
					<div>
						<center><h4 class="grey-text">El Carrito de compras tiene elementos</h4></center>
				...
				echo '<center><h3 id="total">Total:$20.00'.$total.'</h3></center>';

				?>
				<!-- Producto -->	
				<a href="../tienda.php" class="waves-effect waves-light btn-large">Regresar a la tienda</a>
